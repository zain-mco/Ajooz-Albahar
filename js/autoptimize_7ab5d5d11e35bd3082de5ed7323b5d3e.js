...
window.bsfmodernizr = function(a, b, c) {
        function x(a) {
            j.cssText = a
        }
...
var Froogaloop = function() {
    ...
    function c(a) {
        ...
        return b = i ? e[i][c] : e[c], c = [], !!b && (void 0 !== a && c.push(a), h && c.push(h), i && c.push(i), 0 < c.length ? b.apply(null, c) : b.call())
    }
...
function(a, b) {
    ...
    var c = function(b) {
        ...
        d = function() {
            ...
            function f(a, b) {
                return b = K.prototype.toLowerCase.call(b), "finite" == b ? isFinite(a) : !("array" != b || !(a instanceof Array || Array.isArray && Array.isArray(a))) || ("null" == b && null === a || b == typeof a && null !== a || "object" == b && a === Object(a) || U.call(a).slice(8, -1).toLowerCase() == b)
            }
...
function(a) {
    function b(b) {
        var c = "div.ult-overlay." + b;
        if (joverlay = document.querySelector(c), i = a(c), i.hasClass("ult-open")) {
            i.removeClass("ult-open"), i.addClass("ult-close");
            var d = function(a) {
                if (support.transitions) {
                    if ("visibility" !== a.propertyName) return;
                    this.removeEventListener(transEndEventName, d)
                }
                i.removeClass("ult-close")
            };
            support.transitions ? (joverlay.addEventListener(transEndEventName, d), i.removeClass("ult-close"), f < e && a("html").css({
                overflow: "auto"
            })) : d()
        } else i.hasClass("ult-close") || i.addClass("ult-open");
        var e = i.find(".ult_modal").outerHeight(),
            f = a(window).outerHeight();
        f < e && a("html").css({
            overflow: "hidden"
        })
    }
    ...
    function c(b) {
        var c = "div.overlay-cornershape." + b,
            d = document.querySelector(c),
            e = a(c),
            f = Snap(d.querySelector("svg")),
            g = f.select("path"),
            h = {
                from: "m 0,0 1439.999975,0 0,805.99999 0,-805.99999 z ",
                to: " m 0,0 1439.999975,0 0,805.99999 -1439.999975,0 z  "
            };
        if (e.hasClass("ult-open")) {
            e.removeClass("ult-open"), e.addClass("ult-close");
            var i = function(a) {
                e.removeClass("ult-close")
            };
            g.animate({
                path: h.from
            }, 400, mina.linear, i)
        } else e.hasClass("ult-close") || (e.addClass("ult-open"), g.animate({
            path: h.to
        }, 400, mina.linear))
    }

    function d(b) {
        var c = "div.overlay-genie." + b,
            d = document.querySelector(c),
            e = a(c),
            f = Snap(d.querySelector("svg")),
            g = f.select("path"),
            h = d.getAttribute("data-steps").split(";"),
            i = h.length;
        if (e.hasClass("ult-open")) {
            var j = i - 1;
            e.removeClass("ult-open"), e.addClass("ult-close");
    ...
    function f(b) {
        var c = "div.overlay-boxes." + b,
            d = document.querySelector(c),
            f = a(c),
            g = [].slice.call(d.querySelectorAll("svg > path")),
            h = g.length,
            i = 0;
        e(g), f.hasClass("ult-open") ? (f.removeClass("ult-open"), f.addClass("ult-close"), g.forEach(function(a, b) {
            setTimeout(function() {
                ++i, a.style.display = "none", i === h && f.removeClass("ult-close")
            }, 30 * b)
        })) : f.hasClass("ult-close") || (f.addClass("ult-open"), g.forEach(function(a, b) {
            setTimeout(function() {
    ...
    function g(b) {
        var c = a("." + b).find(".ult_modal-content").height(),
            d = a(window).height();
        c > d ? a("." + b).addClass("ult_modal-auto-top") : a("." + b).removeClass("ult_modal-auto-top"), a("." + b).find("iframe").length > 0 && a("." + b).find("iframe").each(function(b, c) {
            a(c).attr("src", a(c).attr("src"))
        }), a(document).trigger("onUVCModalPopupOpen", b)
    }

    function h() {
        a(".ult_modal-body iframe").each(function(b, c) {
            var d = a(this).parent().width(),
                e = (!!a(this).parent().parent().parent().hasClass("ult-small"), !!a(this).parent().parent().parent().hasClass("ult-medium"), !!a(this).parent().parent().parent().hasClass("ult-container")),
                f = !!a(this).parent().parent().parent().hasClass("ult-block"),
                g = d / 10,
                h = d * (9 / 16) + g,
                i = !(!a(this).parent().hasClass("ult-youtube") && !a(this).parent().hasClass("ult-vimeo"));
            if (!i) return !1;
            if (e) {
                var j = a(window).height();
                j < h && (h = j - 100)
            }
            f && (d = a(this).attr("width"), h = a(this).attr("height"), "undefined" != typeof d && "" != d || (d = 640), "undefined" != typeof h && "" != h || (h = 360)), a(this).css({
                width: d + "px",
                height: h + "px"
            })
        })
    }
    var i = (a(".overlay-show"), a("div.ult-overlay"));
    i.find("div.ult-overlay-close");
    transEndEventNames = {
    ...
    a(".overlay-show-cornershape").find("path").attr("d");
    a(window).load(function() {
        var b = new Array;
        a(".ult-onload").each(function(c) {
            b.push(a(this)), setTimeout(function() {
                b[c].trigger("click")
            }, 1e3 * parseInt(a(this).data("onload-delay")))
        }), a(".ult-vimeo iframe").each(function(b, c) {
            var d = (a(this).attr("id"), a(this)[0]),
                e = $f(d);
            e.addEvent("ready", function() {
                e.addEvent("pause"), e.addEvent("finish")
            })
        })
    }), a(document).ready(function() {
        a(".ult-overlay").each(function() {
            a(this).appendTo(document.body)
        }), a(".ult-overlay").show(), a(".overlay-show").each(function(b, c) {
            var d = a(this).data("class-id");
            a("." + d).find(".ult-vimeo iframe").attr("id", "video_" + d), a("." + d).find(".ult-youtube iframe").attr("id", "video_" + d)
        });
        a(document).on("click", ".overlay-show", function(c) {
            c.stopPropagation(), c.preventDefault();
            var d = a(this).data("class-id");
            a("." + d).find(".ult_modal-content").removeClass("ult-hide"), a("." + d).find(".ult-vimeo iframe").html(a(".ult-vimeo iframe").html()), a("." + d).addClass(a(this).data("overlay-class")), setTimeout(function() {
                a("body, html").addClass("ult_modal-body-open"), b(d), g(d)
            }, 500)
        }), a(document).on("click", ".overlay-show-cornershape", function(b) {
            b.stopPropagation(), b.preventDefault();
            var d = a(this).data("class-id");
            a("." + d).find(".ult_modal-content").removeClass("ult-hide"), setTimeout(function() {
                a("." + d).addClass("overlay-cornershape"), c(d), a("body, html").addClass("ult_modal-body-open"), g(d)
            }, 300)
        }), a(document).on("click", "div.overlay-cornershape div.ult-overlay-close", function(b) {
            b.stopPropagation();
            var d = a(this).parents("div.overlay-cornershape").data("class");
            c(d), a("body, html").removeClass("ult_modal-body-open"), a("html").css({
                overflow: "auto"
            }), a(document).trigger("onUVCModalPopUpClosed", d)
        }), a(document).on("click", ".overlay-show-boxes", function(b) {
            b.stopPropagation(), b.preventDefault();
            var c = a(this).data("class-id");
            a("." + c).find(".ult_modal-content").removeClass("ult-hide"), setTimeout(function() {
                a("." + c).addClass("overlay-boxes"), f(c), a("body, html").addClass("ult_modal-body-open"), g(c)
            }, 300)
        }), a(document).on("click", "div.overlay-boxes div.ult-overlay-close", function(b) {
            b.stopPropagation();
            var c = a(this).parents("div.overlay-boxes").data("class");
            f(c), a("body, html").removeClass("ult_modal-body-open"), a("html").css({
                overflow: "auto"
            }), a(document).trigger("onUVCModalPopUpClosed", c)
        }), a(document).on("click", ".overlay-show-genie", function(b) {
            b.preventDefault();
            var c = a(this).data("class-id");
            a("." + c).find(".ult_modal-content").removeClass("ult-hide"), setTimeout(function() {
                a("." + c).addClass("overlay-genie"), d(c), a("body, html").addClass("ult_modal-body-open"), g(c), a("html").css({
                    overflow: "auto"
                })
            }, 300)
        }), a(document).on("click", "div.overlay-genie div.ult-overlay-close", function(b) {
            b.stopPropagation();
            var c = a(this).parents("div.overlay-genie").data("class");
            d(c), a("body, html").removeClass("ult_modal-body-open"), a("html").css({
                overflow: "auto"
            }), a(document).trigger("onUVCModalPopUpClosed", c)
        }), a(document).on("click", ".ult-overlay .ult-overlay-close", function(c) {
            c.stopPropagation(), $this = a(this);
            var d = $this.parents(".ult-overlay").data("class");
            b(d), a("body, html").removeClass("ult_modal-body-open"), $this.parent().find(".ult-vimeo").length && $this.parent().find(".ult-vimeo iframe").each(function(b, c) {
                var d = a(c),
                    e = a(c).attr("src");
                a(c).attr("src", ""), a(c).attr("src", e);
                var c = d[0],
                    f = $f(c);
                f.api("pause")
            }), $this.parent().find(".ult-youtube").length && $this.parent().find(".ult-youtube iframe").each(function(b, c) {
                var d = a(c).attr("src");
                a(c).attr("src", ""), a(c).attr("src", d)
            }), $this.parent().find(".ult-video-shortcode").length && $this.parent().find(".ult-video-shortcode video").each(function(a, b) {
                b.pause()
            }), a("html").css({
                overflow: "auto"
            }), a(document).trigger("onUVCModalPopUpClosed")
        }), a(document).on("click", ".ult-overlay .ult_modal", function(a) {
            a.stopPropagation()
        }), a(document).on("click", ".ult-overlay", function(b) {
            b.stopPropagation(), b.preventDefault(), a(this).find(".ult-overlay-close").trigger("click"), a("html").css({
                overflow: "auto"
            })
        })
    }), a(document).on("onUVCModalPopupOpen", function() {
        h(), a(window).trigger("resize")
    })
}(jQuery);